...
export default function ButtonsDemo() {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <div style={box}>
        {/* 긴 초록 버튼들 */}
        <Button variant="green" size="lg" shape="pill" width={600}>오늘의 습관으로 가기</Button>
        <Button variant="green" size="lg" shape="pill" width={600}>오늘의 집중으로 가기</Button>
        <Button variant="green" size="lg" shape="pill" width={600}>만들기</Button>
        <Button variant="green" size="lg" shape="pill" width={600}>확인</Button>
        <Button variant="green" size="lg" shape="pill" width={600}>수정하러 가기</Button>
        ...
        <div style={row}>
          <Button variant="green" size="md" shape="pill">오늘의 집중으로 가기</Button>
        </div>
        <div style={row}>
          <Button variant="green" size="md" shape="pill">수정하러 가기</Button>
        </div>
        <div style={row}>
          <Button variant="green" size="md" shape="pill">만들기</Button>
        </div>
        <div style={row}>
          <Button variant="green" size="md" shape="pill">확인</Button>
        </div>

        {/* 작은 초록 버튼 */}
        <div style={row}>
          <Button variant="green" size="sm" shape="pill">확인</Button>
        </div>

        {/* 회색 취소 버튼 */}
        <Button variant="cancel" size="md" shape="pill">취소</Button>
