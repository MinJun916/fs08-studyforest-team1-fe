  ...
  return (
    <>
      <div className={`${styles.overlay} ${showPasswordModal ? styles.active : ""}`}>
        <PasswordModal studyName={modalStudyName} onClose={closePasswordModal} onClick={handlePasswordConfirm} />
      </div>
      <div className={styles.root}>
        ...
        <div className={styles.header}>
            ...
            <div className={styles.adminButtons}>
              ...
              <button type="button" onClick={() => openPasswordModal(study?.studyName)}>수정하기</button>
        ...
        <section className={styles.intro} aria-label="스터디 소개 및 포인트">
          <div className={styles.top}>
            ...
            <div className={styles.userButtons}>
              <button type="button" onClick={() => openPasswordModal(study?.studyName)}>오늘의 습관</button>
              <button type="button" onClick={() => openPasswordModal(study?.studyName)}>오늘의 집중</button>
            </div>
          </div>
          <h3>소개</h3>
