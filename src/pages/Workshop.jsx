...
function ForestLogo({ size = "md" }) {
  return (
    <div className={`${styles.logo} ${styles[size]}`} aria-label="공부의 숲 로고">
      <span className={styles.badge} data-variant="pink">공</span>
      <span className={styles.badge} data-variant="yellow">부</span>
      <span className={styles.badge} data-variant="blue">의</span>
      <span className={styles.badge} data-variant="green">숲</span>
    </div>
  );
}
...
function Now() {
  ...
  return (
    <div className={styles.nowRow}>
      ...
      <span className={styles.nowBadge} aria-live="polite">{text}</span>
    </div>
  );
}
